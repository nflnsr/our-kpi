  ...
  return (
    <>
      ...
      >
        ...
        <div ref={componentRef} className="w-full px-4 overflow-x-auto overflow-y-hidden sm:px-10">
        ...
        <div className={`pt-2 ${isLoading ? "absolute bottom-2 right-40" : "flex justify-end w-full mr-8 sm:mr-20"}`}>
          <button
